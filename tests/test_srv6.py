...
class TestSrv6VpnFpmsyncd(object):
    ...
    def test_AddRemoveSrv6SteeringRouteIpv4(self, dvs, testlog):
        ...
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"ip route 192.0.2.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:1:e000::\"")
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:1:e000::\"")
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:3:e000::\"")
        ...
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"no ip route 192.0.2.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:1:e000::\"")
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"no ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:1:e000::\"")
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"no ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:3:e000::\"")
    ...
    def test_AddRemoveSrv6SteeringRouteIpv6(self, dvs, testlog):
        ...
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"nov7 ip route 2001:db8:2:2::/64 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:1:e000::\"")
    ...
    def test_AddRemoveSrv6SteeringRouteMultipleSids(self, dvs, testlog):
        ...
        # configure srv6 usid locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fcbb:bbbb:1::/48\" -c \"format usid-f3216\"")
        ...
        # configure routes to steer prefixes over the SID list
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"ip route 192.0.2.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fcbb:bbbb:2:3:4:5:6:7/fcbb:bbbb:8:9:e000::\"")

        time.sleep(3)

        # check application database
        self.pdb.wait_for_entry("ROUTE_TABLE", "Vrf13:192.0.2.0/24")
        expected_fields = {"segment": "fcbb:bbbb:2:3:4:5:6:7|fcbb:bbbb:8:9:e000::", "seg_src": "fcbb:bbbb:1::1"}
        self.pdb.wait_for_field_match("ROUTE_TABLE", "Vrf13:192.0.2.0/24", expected_fields)

        self.pdb.wait_for_entry("SRV6_SID_LIST_TABLE", "fcbb:bbbb:2:3:4:5:6:7|fcbb:bbbb:8:9:e000::")
        expected_fields = {"path": "fcbb:bbbb:2:3:4:5:6:7,fcbb:bbbb:8:9:e000::"}
        self.pdb.wait_for_field_match("SRV6_SID_LIST_TABLE", "fcbb:bbbb:2:3:4:5:6:7|fcbb:bbbb:8:9:e000::", expected_fields)
        ...
        for fv in fvs:
            if fv[0] == "SAI_SRV6_SIDLIST_ATTR_SEGMENT_LIST":
                assert fv[1] == "2:fcbb:bbbb:2:3:4:5:6:7,fcbb:bbbb:8:9:e000::"
            elif fv[0] == "SAI_SRV6_SIDLIST_ATTR_TYPE":
                assert fv[1] == "SAI_SRV6_SIDLIST_TYPE_ENCAPS_RED"
        ...
        # check application database
        self.pdb.wait_for_deleted_entry("ROUTE_TABLE", "Vrf13:192.0.2.0/24")
        self.pdb.wait_for_deleted_entry("SRV6_SID_LIST_TABLE", "fcbb:bbbb:2:3:4:5:6:7|fcbb:bbbb:8:9:e000::")
