...
class TestSrv6MySidFpmsyncd(TestSrv6Mysid):
    ...
    def test_AddRemoveSrv6MySidEndT(self, dvs, testlog):
        self.setup_srv6(dvs)

        # configure srv6 locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fc00:0:0:1::/64 block-len 40 node-len 24 func-bits 16\"")

        # create srv6 mysid end.t behavior
        dvs.runcmd("ip -6 route add fc00:0:0:1:66::/128 encap seg6local action End.T table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:66::")
        ...
        for fv in fvs:
            if fv[0] == "SAI_MY_SID_ENTRY_ATTR_ENDPOINT_BEHAVIOR":
                assert fv[1] == "SAI_MY_SID_ENTRY_ENDPOINT_BEHAVIOR_T"
            if fv[0] == "SAI_MY_SID_ENTRY_ATTR_VRF":
                assert fv[1] == self.vrf_id

        # remove srv6 mysid end.t behavior
        dvs.runcmd("ip -6 route del fc00:0:0:1:66::/128 encap seg6local action End.T table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:66::")
    ...
    def test_AddRemoveSrv6MySidEndDX6(self, dvs, testlog):
        self.setup_srv6(dvs)

        # configure srv6 locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fc00:0:0:1::/64 block-len 40 node-len 24 func-bits 16\"")

        # create srv6 mysid end.dx6 behavior
        dvs.runcmd("ip -6 route add fc00:0:0:1:67::/128 encap seg6local action End.DX6 nh6 2001::1 dev sr0")

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:67::")
        ...
        # remove srv6 mysid end.dx6 behavior
        dvs.runcmd("ip -6 route del fc00:0:0:1:67::/128 encap seg6local action End.DX6 nh6 2001::1 dev sr0")

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:67::")
    ...
    def test_AddRemoveSrv6MySidEndDX4(self, dvs, testlog):
        self.setup_srv6(dvs)

        # configure srv6 locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fc00:0:0:1::/64 block-len 40 node-len 24 func-bits 16\"")

        # create srv6 mysid end.dx4 behavior
        dvs.runcmd("ip -6 route add fc00:0:0:1:68::/128 encap seg6local action End.DX4 nh4 192.0.2.1 dev sr0")

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:68::")
        ...
        # remove srv6 mysid end.dx4 behavior
        dvs.runcmd("ip -6 route del fc00:0:0:1:68::/128 encap seg6local action End.DX4 nh4 192.0.2.1 dev sr0")

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:68::")
    ...
    def test_AddRemoveSrv6MySidEndDT6(self, dvs, testlog):
        ...
        dvs.runcmd("ip -6 route add fc00:0:0:1:69::/128 encap seg6local action End.DT6 table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:69::")
        ...
        dvs.runcmd("ip -6 route del fc00:0:0:1:69::/128 encap seg6local action End.DT6 table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:69::")
    ...
    def test_AddRemoveSrv6MySidEndDT4(self, dvs, testlog):
        ...
        dvs.runcmd("ip -6 route add fc00:0:0:1:6a::/128 encap seg6local action End.DT4 vrftable {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:6a::")
        ...
        dvs.runcmd("ip -6 route del fc00:0:0:1:6a::/128 encap seg6local action End.DT4 vrftable {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "40:24:16:0:fc00:0:0:1:6a::")
    ...
    def test_AddRemoveSrv6MySidUDX6(self, dvs, testlog):
        self.setup_srv6(dvs)

        # configure srv6 usid locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fc00:0:2::/48 block-len 32 node-len 16 func-bits 16\" -c \"behavior usid\"")

        # create srv6 mysid udx6 behavior
        dvs.runcmd("ip -6 route add fc00:0:2:ff01::/128 encap seg6local action End.DX6 nh6 2001::1 dev sr0")

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff01::")
    ...
    def test_AddRemoveSrv6MySidUDX4(self, dvs, testlog):
        self.setup_srv6(dvs)

        # configure srv6 usid locator
        dvs.runcmd("vtysh -c \"configure terminal\" -c \"segment-routing\" -c \"srv6\" -c \"locators\" -c \"locator loc1\" -c \"prefix fc00:0:2::/48 block-len 32 node-len 16 func-bits 16\" -c \"behavior usid\"")

        # create srv6 mysid udx4 behavior
        dvs.runcmd("ip -6 route add fc00:0:2:ff02::/128 encap seg6local action End.DX4 nh4 192.0.2.1 dev sr0")

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff02::")
        ...
        # remove srv6 mysid udx4 behavior
        dvs.runcmd("ip -6 route del fc00:0:2:ff02::/128 encap seg6local action End.DX4 nh4 192.0.2.1 dev sr0")

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff02::")
    ...
    def test_AddRemoveSrv6MySidUDT6(self, dvs, testlog):
        ...
        dvs.runcmd("ip -6 route add fc00:0:2:ff03::/128 encap seg6local action End.DT6 table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff03::")
        ...
        dvs.runcmd("ip -6 route del fc00:0:2:ff03::/128 encap seg6local action End.DT6 table {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff03::")
    ...
    def test_AddRemoveSrv6MySidUDT4(self, dvs, testlog):
        ...
        dvs.runcmd("ip -6 route add fc00:0:2:ff04::/128 encap seg6local action End.DT4 vrftable {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff04::")
        ...
        dvs.runcmd("ip -6 route del fc00:0:2:ff04::/128 encap seg6local action End.DT4 vrftable {} dev sr0".format(self.vrf_table_id))

        # check application database
        self.pdb.wait_for_deleted_entry("SRV6_MY_SID_TABLE", "32:16:16:0:fc00:0:2:ff04::")
...
class TestSrv6VpnFpmsyncd:
    ...
    def test_AddRemoveSrv6VpnRouteIpv4(self, dvs, testlog):
        ...
        self.adb.wait_for_n_keys("ASIC_STATE:SAI_OBJECT_TYPE_TUNNEL_MAP_ENTRY", len(map_entry_entries))
        self.adb.wait_for_n_keys("ASIC_STATE:SAI_OBJECT_TYPE_TUNNEL", len(tunnel_entries))
        self.adb.wait_for_n_keys("ASIC_STATE:SAI_OBJECT_TYPE_TUNNEL_MAP", len(map_entries))
