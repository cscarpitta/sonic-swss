...
class TestSrv6VpnFpmsyncd(object):
    ...
    def test_AddRemoveSrv6SteeringRouteIpv4(self, dvs, testlog):
        ...
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:9:8:7:6:5:4/fc00:0:3:e000::\"")
        ...
        dvs.runcmd("vtysh -c \"configure terminal\" vtysh -c \"no ip route 192.0.3.0/24 sr0 vrf Vrf13 nexthop-vrf default segments fc00:0:9:8:7:6:5:4/fc00:0:3:e000::\"")
